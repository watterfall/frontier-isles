...
- ⏭️ **M8 微动态第二批(跳过)**:萤火 / 夜市灯 —— 需要 `ParticleContainer` 与尚未建的附件原语,代价明显高于炊烟/旗帜,本轮不做,原因record 在下面「P1 · 计划内下一批」条目里,未删除任务本身。
...
- **M8 微动态第二批 · 萤火 / 夜市灯**:需 `ParticleContainer` + 未建的附件原语(炊烟/旗帜已上线,见上)。
