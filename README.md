...
- **Cross-domain exploration**: open “领域碰撞” to follow six thematic question archipelagos, branch from real xFrontier relations, keep free-form thoughts, and bring actual toy-model observations back to your trail. Optional AI collaboration reads question sources and proposes connections, alternatives and probes; it requires a configured server-side provider and a signed-in session. No completion scores or stamps. See [`docs/upgrade-v2-2026-09-06.md`](docs/upgrade-v2-2026-09-06.md) for setup, scope and source boundaries.
