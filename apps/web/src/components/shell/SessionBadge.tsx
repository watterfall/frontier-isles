...
export function SessionBadge() {
  ...
  if (me === null) {
    return (
      <a href="/api/auth/github" className="fi-shell-pill fi-session-login">
  ...
  return (
    <span className="fi-shell-pill fi-session-badge">
      <span className="fi-session-status" aria-hidden="true" />
      <span className="fi-session-handle">{me.handle.replace(/^github:/, '@')}</span>
      <button
        type="button"
        className="fi-session-logout"
        onClick={() => {
